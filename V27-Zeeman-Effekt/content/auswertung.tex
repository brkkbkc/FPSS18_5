...
\end{figure}
  ...
  \subsection{\texorpdfstring{Bestimmung des Lande-Faktors $g_{12}$ der $\sigma$-"Uberg"ange f"ur die blaue Linie}{Bestimmung des Lande-Faktors g_{12} der sigma-"Uberg"ange f"ur die blaue Linie}}
    ...
    MERKTEXT FUER DIESEN AUSWERTUNGSTEIL:Hier zwei verschiedene g12 f"ur die zwei  uebergaenge, deshlmb. die zwei aufgeteilten linien sind eigentlich 4, die 3/2 linie und die 2 linie ueberlagern sich nur, weil mit dieser apperatir nicht genau aufgeloest werden koennen.
