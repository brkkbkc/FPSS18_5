...
\label{spannung}
\end{align}
Mit $I_N = 0$ folgt für den unbelasteten Spannungsteiler am Knotenpunkt A
\begin{align}
...
Nach Formel (\ref{timbugtu}) ist im logarithmischen Diagramm ein linearer Verlauf der Ausgangspannung $U_A$ als Funktion der Speisefrequenz $\nu$ zu erwarten.
