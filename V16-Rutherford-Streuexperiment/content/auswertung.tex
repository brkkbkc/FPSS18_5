...
\subsection{Die Aktivit"at der Americum-Quelle}
  ...
  \begin{equation}
    \frac{4\pi(\SI{0,0041}{\meter}+\SI{0,0039}{\meter}+\SI{0.0017}{\meter})^2}{F}Z_{gemessen}
  \end{equation}
  ,weil davon ausgegangen wird, dass die Quelle homogen in alle Raumrichtungen strahlt.
  Es ergibt sich:
  \begin{equation}
    Z_{Quelle} = \SI{}{\kilo \becquerel}
  \end{equation}

  Der theoretisch zu erwartende Wert kann mithilfe des Zerfallsgesetzes berechnet werden:
  \begin{equation}
    Z_{Quelle} = Z_0\text{e}^{\frac{\ln(2)t}{\tau}} \approx \SI{318}{\kilo \becquerel}
  \end{equation}
  Dabei ist $\tau=432,2$ Jahre die Halbwertszeit und $Z_0=\SI{330}{\kilo \becquerel}$ die urspr"ungliche Aktivit"at.
