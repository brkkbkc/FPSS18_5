...
\begin{figure}
  ...
  \begin{subfigure}{0.8\textwidth}
    \includegraphics[width=\textwidth]{figures/intensity.png}
  ...
  \begin{subfigure}{0.8\textwidth}
    \includegraphics[width=\textwidth]{figures/contrast.png}
...
\begin{figure}
  \centering
  \includegraphics[width=0.8\textwidth]{figures/pressure-ref-index.png}
